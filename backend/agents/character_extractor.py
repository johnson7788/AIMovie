...
class CharacterExtractor:
    ...
    async def extract_characters(self, script: str) -> List[CharacterInScene]:
        print(f"🔍 Extracting characters via {self.chat_model.model_name} ...")
        ...
        print(f"✅ Character extraction completed in {elapsed:.1f}s ({len(response.characters)} characters)")
